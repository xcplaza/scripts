...
$token = Invoke-RestMethod -Method Post -Uri "https://il01-cloud.acronis.com/api/2/idp/token" -Headers $headers -Body $postParams
...
$baseuri = "https://il01-cloud.acronis.com/"
